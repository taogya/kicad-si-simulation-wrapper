...
def main(config_file: Annotated[Path, typer.Option("--file", "-f", help="Path to settings file")],
    ...
    for i in range(len(terminate_tracks)):
        ...
        net_length_3, net_width_3, net_start_pos_3, net_end_pos_3, net_impedance_3 = pcb_slice.get_selected_track_info(
            whole_track
        )
        logger.debug(
        ...
        port_cfg.add_simulation_port(i + 1, net_width_3, 500000, net_impedance_3, sp_termination_layer, plane, False)
